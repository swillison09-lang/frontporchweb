...
const SEED_BUSINESS_TYPES = [
  {
    ...
    tiers: [
      ...
      { id: 'professional-starter',  name: 'Starter',  price: '$350',   badge: null,            features: ['Up to 4 sections', 'Mobile-friendly', 'Contact form', '1 round of revisions'] },
      { id: 'professional-standard', name: 'Standard', price: '$600',   badge: 'Most Popular',  features: ['Up to 8 sections', 'Photo gallery', 'Basic SEO setup', '2 rounds of revisions'] },
      { id: 'professional-premium',  name: 'Premium',  price: '$850',   badge: null,            features: ['All the sections you need', 'Blog you update yourself', 'Online enquiry / booking', '3 rounds of revisions'] },
    ],
    photoCategories: [
  ...
  },
  {
    ...
    tiers: [
      ...
      { id: 'personal-starter',  name: 'Starter',  price: '$450',   badge: null,            features: ['Single-page personal site'] },
      { id: 'personal-standard', name: 'Standard', price: '$750',   badge: 'Most Popular',  features: ['Up to 8 sections with gallery'] },
      { id: 'personal-premium',  name: 'Premium',  price: '$1,100', badge: null,            features: ['Adds a blog / updates section'] },
    ],
    photoCategories: [
  ...
  },
  {
    ...
    tiers: [
      // Names MUST be Starter/Standard/Premium — getStripeLinkFor() matches on
      // tier name, so anything else returns null and Pay & Submit dead-ends.
      { id: 'adoption-starter',  name: 'Starter',  price: '$400',   badge: null,            features: ['Warm profile site', 'Photo gallery', 'Contact'] },
      { id: 'adoption-standard', name: 'Standard', price: '$600',   badge: 'Most Popular',  features: ['Adds journey blog / vlog feed', 'Fundraising section'] },
      { id: 'adoption-premium',  name: 'Premium',  price: '$850',   badge: null,            features: ['Adds editable family login', 'Admin features'] },
    ],
    photoCategories: [
  ...
  },
  {
    ...
    tiers: [
      { id: 'recruiting-starter',  name: 'Starter',  price: '$350',   badge: null,            features: ['Single-page recruiting profile', 'Embedded highlight video', 'Stats and academics', 'Contact + coach info'] },
      { id: 'recruiting-standard', name: 'Standard', price: '$550',   badge: 'Most Popular',  features: ['Up to 8 sections', 'Photo gallery + multiple highlight videos', 'Social bio link block', 'Basic SEO so coaches find you'] },
      { id: 'recruiting-premium',  name: 'Premium',  price: '$800',   badge: null,            features: ['Everything in Standard', 'Game film library', 'News / season updates section', 'Custom domain + analytics'] },
    ],
    photoCategories: [
